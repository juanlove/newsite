...
// hello@juanlove.design or juanlovedesign@gmail.com
$sendTo = 'hello@juanlove.design;'
...
// error_reporting( E_ALL & ~E_NOTICE ); // - Debugging on
error_reporting(0); // - Debugging off
